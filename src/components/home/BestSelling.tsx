  ...
  return (
    <div className=" w-[1092px] h-[568px] mb-40 justify-self-center justify-items-center">
      <div className="h-[62px]  w-[139px] mb-20">
        <Link to="/shop">
            <p className="mb-2  w-fit font-inter font-medium text-xs text-bl300 hover:text-bl600">Shop Now</p>
        </Link>
        <h2 className="font-inter  w-fit font-bold text-2xl text-bl900">Best Selling</h2>
      </div>
